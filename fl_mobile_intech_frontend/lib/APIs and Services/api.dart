class API {
  ...
  static const String version = '/api/v1.0/';
  ...
  static const String uploadPost = 'uploads/post/image';
  ...
  static const String getAllPosts =
      'https://llokality-intech-xald7lspga-el.a.run.app/api/v1.0/posts/0&3';
}
